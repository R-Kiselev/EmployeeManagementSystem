...
import com.example.employeemanagementsystem.exception.ResourceNotFoundException; // Важно!
...
@Mapper(componentModel = "spring", uses = {DepartmentMapper.class, PositionMapper.class, UserMapper.class},
